package com.distributedlog.system.consumer.service;

import com.distributedlog.system.consumer.model.LogEvent;
import com.distributedlog.system.consumer.repository.LogEventRepository;
...
public class LogEventConsumerSrv {

    private static final Logger logger = LoggerFactory.getLogger(LogEventConsumerSrv.class);
    ...
    public LogEventConsumerSrv(MeterRegistry meterRegistry) {
